...
class PixelInfoWrapper(gym.Wrapper):
    """Wrapper that adds pixel s to info dict."""
    ...
    def reset(
        ...
        return obs, self._add_pixel_info(info)
    ...
    def step(
        ...
        return observation, reward, terminated, truncated, self._add_pixel_info(info)
