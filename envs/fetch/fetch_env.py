...
from envs.robot_env import MujocoPyRobotEnv, MujocoRobotEnv
    ...
    class BaseFetchEnv(RobotEnvClass):
        ...
        def __init__(
            ...
            **kwargs
            ...
            self.use_velocity_obs = use_velocity_obs
        ...
        def _get_obs(self):
            ...
            if self.use_velocity_obs:
                obs = np.concatenate([static_obs, vel_obs])
            else:
                obs = static_obs
