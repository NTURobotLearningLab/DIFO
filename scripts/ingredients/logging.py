...
from imitation.util import logger as imit_logger, sacred as sacred_util, util
from scripts.ingredients import environment, wb
...
def config():
    ...
    log_format_strs = ["wandb"]  # ["tensorboard", "stdout", "wandb"]
