...
def config():
    ...
    env_wrappers = []  # The kwargs passed to `wrappers.make_vec_env`.
    frame_stack = None  # Number of frames to stack in the observation space
    gym_id = "seals/CartPole-v0"  # The environment to train on
    video_record = False  # Whether to record videos of the environment
...
def make_venv(
    ...
    env_wrappers: Iterable[Mapping[str, Any]],
    video_record: bool,
    frame_stack: int,
    _run: sacred.run.Run,
