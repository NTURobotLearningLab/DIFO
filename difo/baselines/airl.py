...
from difo.difo.reward_fn import (
    REWARD_FN_DICT,
    AIRLPositiveRewardNetFromDiscriminatorLogit,
)
...
class AIRL(common.AdversarialTrainer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._calc_log_policy_act_prob = True
        super().__init__(
    ...
    def calc_loss(
        ...
        log_policy_act_prob: th.Tensor | None = None,
        labels_expert_is_one: th.Tensor = None,
    ) -> Tuple[th.Tensor, th.Tensor, Mapping | None]:
