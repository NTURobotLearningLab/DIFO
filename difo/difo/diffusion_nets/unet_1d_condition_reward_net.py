...
class UNet1DConditionRewardNet(DIFORewardNet):
    ...
    def __init__(
        ...
        sample_strategy_kwargs: Dict[str, Any] = dict(low=250, high=750, n_sample=1),
        ...
        if use_action or use_done:
            raise NotImplementedError(
                "use_action and use_done not implemented for UNet1DRewardNet"
            )
