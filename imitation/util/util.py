...
def make_vec_env(
    ...
    *,
    ...
    env_wrappers: Optional[Iterable[Mapping[str, Any]]] = None,
    ...
    def make_env(i: int, this_seed: int) -> gym.Env:
        ...
        for wrapper_name in env_wrappers:
            wrapper_class = wrapper_name.get("cls")
            kwargs = wrapper_name.get("kwargs")
    ...
    if frame_stack is not None:
        vec_env = VecFrameStack(vec_env, frame_stack)
    ...
    vec_env = BaseAlgorithm._wrap_env(vec_env, verbose=1)
